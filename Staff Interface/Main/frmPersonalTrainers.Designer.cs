namespace csCY_Avenue.Staff_Interface.Main
{
    partial class frmPersonalTrainers
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvPersonalTrainers.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
            dgvPersonalTrainers.ColumnHeadersHeight = 35;
            dgvPersonalTrainers.Columns.AddRange(new DataGridViewColumn[] { ID, Fullname, Age, Gender, Birthdate, Email, Status, AsignedMembers, TrainerClasses });
            ...
            Text = "frmPersonalTrainerGridView";
