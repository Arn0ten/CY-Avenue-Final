...
public class ScheduleCreateFixed
{
    private DatabaseConnection dbConnection;

    public ScheduleCreateFixed(DatabaseConnection dbConnection)
    {
    ...
    public bool CreateClassSession(ClassSession? classSession, out string message)
    {
        ...
        try
        {
            ...
            using (MySqlCommand command = new MySqlCommand("prcFixedSessionCreateNew", dbConnection.mysqlConnection,
