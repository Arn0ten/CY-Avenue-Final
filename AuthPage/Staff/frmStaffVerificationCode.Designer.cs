...
{
    partial class frmStaffVerificationCode
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            txtVerificationCode = new Guna.UI2.WinForms.Guna2TextBox();
            btnExit = new Button();
            label2 = new Label();
            lblLogin = new Label();
            ...
            guna2ShadowPanel1.Controls.Add(txtVerificationCode);
            ...
            // txtVerificationCode
            // 
            txtVerificationCode.BorderRadius = 5;
            txtVerificationCode.CustomizableEdges = customizableEdges1;
            txtVerificationCode.DefaultText = "";
            txtVerificationCode.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
            txtVerificationCode.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
            txtVerificationCode.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
            txtVerificationCode.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
            txtVerificationCode.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
            txtVerificationCode.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            txtVerificationCode.ForeColor = Color.Black;
            txtVerificationCode.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
            txtVerificationCode.Location = new Point(38, 38);
            txtVerificationCode.Margin = new Padding(3, 4, 3, 4);
            ...
            txtVerificationCode.ShadowDecoration.CustomizableEdges = customizableEdges2;
            txtVerificationCode.Size = new Size(405, 39);
            txtVerificationCode.TabIndex = 17;
            // 
            // btnExit
            // 
            ...
            label2.TabIndex = 11;
            label2.Text = "Enter the verification code sent to your email  :";
            // 
            // lblLogin
            // 
            ...
            lblLogin.Size = new Size(234, 37);
            lblLogin.TabIndex = 10;
            lblLogin.Text = "Verify Your Email";
            // 
            // frmStaffVerificationCode
            // 
            ...
            Name = "frmStaffVerificationCode";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "frmAdminVerificationCode";
